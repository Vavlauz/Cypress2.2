...
Cypress.Commands.add(
  ...
  (id, username, firstName, lastName, email, password, phone, userStatus) => {
    cy.request({
      ...
      url: "https://petstore.swagger.io/v2/user/Vavlauz", // пишем url, тот, куда будем направлять запрос
      body: {
        // описываем юзера или новые данные для него
        id: id,
        username: username,
